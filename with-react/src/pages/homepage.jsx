    ...
    <>
      <Column className="bg-light_green flex flex-col font-inter items-center justify-start mx-[auto] w-[100%]">
        ...
        <Column className="flex flex-col items-center justify-start sm:mt-[28px] md:mt-[37px] mt-[54px] w-[100%]">
          <Column className=" flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[1317px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%] justify-around">
            <Column className="flex flex-col sm:mx-[0] sm:px-[0] sm:w-[100%] w-[47%]">
              <Column className="flex flex-col items-center justify-start md:mt-[10px] mt-[15px] sm:mt-[7px] w-[100%]">
                <Text
                  className=" font-bold text-5xl md:leading-[normal] sm:leading-[normal] text-gray_901 w-[100%]"
                  as="h2"
                  variant="h2"
                >
                  Grow up your skills by online courses with Skill-Learn
                </Text>
                {/* <Text
          ...
          <Stack className="h-[1120px] max-w-[1098px] ml-[auto] mr-[auto] md:mt-[103px] mt-[150px] sm:mt-[79px] sm:pl-[15px] sm:pr-[15px] relative w-[100%]">
            <Stack className="absolute h-[465px] right-[0] top-[0] sm:w-[100%] w-[90%]">
              <Column className="absolute flex flex-col items-center justify-start left-[0] sm:mx-[0] sm:px-[0] rounded-radius10 top-[0] sm:w-[100%] w-[86%]">
                <Text
                  className="font-bold font-Roboto leading-[55.00px] md:leading-[normal] sm:leading-[normal] sm:mx-[0] text-center text-gray_901 sm:w-[100%] w-[67%]"
                  as="h2"
                  variant="h2"
                >
          ...
          <Column className="bg-very_light_green flex flex-col font-inter items-end justify-start max-w-[1280px] ml-[auto] mr-[auto] md:mt-[103px] mt-[150px] sm:mt-[79px] sm:mx-[0] sm:pl-[15px] md:pl-[26px] pl-[38px] sm:pr-[15px] sm:py-[15px] md:py-[26px] py-[38px] rounded-radius20 w-[100%]">
