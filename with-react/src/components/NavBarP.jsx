...
const NavBarP = () => {
  ...
  return (
    ...
    // <header className=" bg-light_green w-[100%]">
    // <Row className="bg-light_green flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[auto] ml-[auto] mr-[auto] md:p-[5px] p-[12px] sm:pl-[15px] sm:pr-[15px] sm:px-[15px] sm:py-[11px] w-[100%]">
    ...
    //     <Input
    //       className="font-medium p-[10px] text-[16px] placeholder:text-gray_700 text-gray_700 w-[90%]"
